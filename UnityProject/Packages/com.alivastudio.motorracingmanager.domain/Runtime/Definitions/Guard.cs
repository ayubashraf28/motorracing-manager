...
namespace MotorracingManager.Domain.Definitions
{
    internal static class Guard
    {
        ...
        public static void AgainstDefaultIdentifier(string value, string paramName)
        {
            if (string.IsNullOrWhiteSpace(value))
            {
                throw new ArgumentException("Identifier cannot be default or whitespace.", paramName);
            }
        }
    }
}
